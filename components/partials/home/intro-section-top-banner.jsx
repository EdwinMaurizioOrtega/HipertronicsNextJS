...
function IntroSectionTopBanner ( props ) {
    return (
        <div className="row">
            <div className="col-lg-12 mb-4">
                ...
                {/*<OwlCarousel adClass="owl-theme owl-dot-inner intro-slider animation-slider" >*/}
...
export default React.memo( IntroSectionTopBanner );